...
int nconst;                      /* Number of constituents */
...
/* and open the tidal data files */
  ...
  if(( cfg = fopen( "C:\\CSSPApp\\tidetest\\Debug\\tidecor2.5.cfg", "r" )) == NULL ) {
    fprintf( stderr,"Error in opening the configuration file tidecor2.5.cfg\n");
...
/* Ouput the tidal correction */
    if( cplx == 0 ) {
    fprintf( tidecorfile,
      "%7.4lf %13.8lf %13.8lf %4ld %2d %2d %2ld %2ld %5.2lf\n", reslt,
      longitude, latitude, year,month, day, hour, minute, seconds);
    fprintf( stdout,
      "%7.4lf %13.8lf %13.8lf %4ld %2d %2d %2ld %2ld %5.2lf\n", reslt,
      longitude, latitude, year,month, day, hour, minute, seconds);
/*    printf( "%7.4lf %13.8lf %13.8lf %4ld %2d %2d %2ld %2ld %5.2lf\n",
      reslt, longitude, latitude, year, month, day, hour, minute,
      seconds);*/
    } else {
    fprintf( tidecorfile,
      "%7.4lf %7.4f %13.8lf %13.8lf %4ld %2d %2d %2ld %2ld %5.2lf\n",
      reslt, reslt2, longitude, latitude, year, month, day, hour,
      minute, seconds);
    }
  }
...
/* Allocate memory for input variables */
  ...
  if(( VUF = fopen( "C:\\CSSPApp\\tidetest\\Debug\\IOS_tidetbl", "r" )) == NULL ) {
